...
.write-btn{background:var(--accent);color:#fff;border-radius:8px;padding:5px 14px;font-size:13px;transition:background .15s}
.write-btn:hover{background:#1d4ed8;color:#fff}
...
<div class="wrap">
  <div class="head">
    ...
    <div class="head-links">
      <a class="back write-btn" href="write.html">✍️ 写文章</a>
